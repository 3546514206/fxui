...
public class BorderAnimationExample extends StackPane {

    private double width = 200;
    private double height = 200;
    private double radius = Math.sqrt(width * width + height * height) / 2;
    ...
    public BorderAnimationExample(Node main) {
